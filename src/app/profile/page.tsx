...
export default function Page() {
  ...
  const allGoals = useQuery(api.goals.retrievePersonalGoals, { userId });
            ...
            {showGoalForm ? (
              <form onSubmit={addGoal}>
                ...
                <input
                  ...
                  onChange={(e) => setGoal({ ...goal, goal: e.target.value })}
                  value={goal.goal}
                />
                ...
                <button
                  type="submit"
                  className="border-4 border-amber-400 rounded-md hover:bg-blue-500"
                >
                  Enter
                </button>
              </form>
